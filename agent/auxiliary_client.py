...
def _build_call_kwargs(
    ...
    # Z.AI: force thinking on for all zai calls (captcha/vision accuracy,
    # memory distillation). Upstream's reasoning framework above is
    # provider-generic; Z.AI's API uses the 'thinking' key, so set it
    # for zai unless the caller explicitly provided one.
